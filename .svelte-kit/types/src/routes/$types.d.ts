...
type LayoutRouteId = RouteId | "/" | "/about" | "/admin" | "/admin/admins" | "/admin/comments" | "/admin/dashboard" | "/admin/forgot" | "/admin/home" | "/admin/login" | "/admin/programs" | "/admin/reset" | "/admin/settings" | "/admin/submissions" | "/admin/works" | "/app/drafted" | "/app/home" | "/app/liked" | "/app/profile" | "/app/settings" | "/app/submit" | "/app/submit/success" | "/app/submitted" | "/auth/callback" | "/auth/forgot" | "/auth/otp" | "/auth/reset" | "/auth/sign-in" | "/auth/sign-up" | "/opportunities" | "/programs" | "/support" | "/works" | "/works/[slug]" | "/writing-guide" | null
