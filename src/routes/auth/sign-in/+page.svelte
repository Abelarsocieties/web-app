		...
		<div class="w-full max-w-md animate-fade-in">
			...
			<form on:submit|preventDefault={handleSignIn} class="space-y-5">
					...
					<div class="p-4 bg-amber-50 border-2 border-amber-300 text-amber-800 text-sm transition-all duration-300 rounded animate-fade-in" role="alert">
						<div class="flex items-start gap-3">
							...
							<div class="flex-1">
								...
								<p class="text-xs opacity-90">We're polishing our social authentication features. For now, please use email and password to sign in.</p>
							</div>
						</div>
					</div>
				{/if}
				...
				<div class="flex items-center justify-between">
					<label class="flex items-center gap-2 cursor-pointer">
						...
						/>
						<span class="text-sm text-gray-600" style="font-family: 'Space Grotesk', sans-serif;">Remember for 30 days</span>
					</label>
					<a href="/auth/forgot" class="text-sm text-primary hover:underline font-medium transition-colors duration-300" style="font-family: 'Space Grotesk', sans-serif;">Forgot password</a>
				</div>
			...
			<div class="mt-6 text-center">
				<p class="text-sm text-gray-600" style="font-family: 'Space Grotesk', sans-serif;">
					Don't have an account? <a href="/auth/sign-up" class="text-primary hover:underline font-medium transition-colors duration-300">Sign up</a>
				</p>
			</div>
		</div>
	</div>
