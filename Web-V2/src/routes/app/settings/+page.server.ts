...
export const actions: Actions = {
	...
	updateSecurity: async () => {
		return fail(501, {
			error: 'Password changes are not wired to the published PHP API in this app. Use your backend user management or extend the API.'
		});
	},

	updateNotifications: async () => {
		return fail(501, {
			error: 'Notification preferences are not in the published OpenAPI spec for this API.'
		});
	}
};
